...
class RequestTest extends TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['REQUEST_URI'] = '/date-picker.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/date-picker.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/date-picker.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/date-picker.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/date-picker.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/date-picker.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/date-picker.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide date-picker.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ date-picker.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/date-picker.php';
        $server['PHP_SELF'] = '/date-picker.php';
        $server['SCRIPT_FILENAME'] = '/some/where/date-picker.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/date-picker.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/date-picker.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/date-picker.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/date-picker.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/date-picker.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/date-picker.php';
        $server['ORIG_SCRIPT_NAME'] = '/date-picker.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/date-picker.php',
                    'SCRIPT_NAME' => '/fruit/date-picker.php',
                    'PHP_SELF' => '/fruit/date-picker.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/date-picker.php',
                    'SCRIPT_NAME' => '/date-picker.php',
                    'PHP_SELF' => '/date-picker.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
