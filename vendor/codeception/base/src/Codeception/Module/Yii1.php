 ...
 *
 *  * `appPath` - full path to the application, include date-picker.php</li>
 *  * `url` - full url to the date-picker.php entry script</li>
 *
 * In your date-picker.php you must return an array with correct configuration for the application:
 *
 * For the simple created yii application date-picker.php will be like this:
 *
 * ```php
 * <?php
 ...
 *     enabled:
 *         - Yii1:
 *             appPath: '/path/to/date-picker.php'
