 ...
 * then the themed version for a view file `@app/views/site/date-picker.php` will be
 * `@app/themes/basic/site/date-picker.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/date-picker.php` or
 * `@app/themes/basic/site/date-picker.php`. The former has precedence over the latter if both files exist.
 *
