...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/date-picker.php` but not `views/controller/date-picker.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `date-picker.php` but not `views/start/date-picker.php`.
